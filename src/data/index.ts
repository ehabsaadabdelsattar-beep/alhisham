...
export const projects: Project[] = [
  {
    ...
    locationAr: 'بني سويف، مدينة بني سويف الجديدة',
    locationEn: 'Beni Suef, New Beni Suef City',
    category: 'residential',
    status: 'completed',
    progress: 100,
    image: '/images/nakheel_residence.png',
    images: [
      '/images/nakheel_residence.png',
    ],
    ...
    year: '2023',
    units: 120,
    mapEmbedUrl: 'https://maps.google.com/maps?q=29.0333,31.0833&z=15&output=embed',
  },
  {
    id: 'mall-of-egypt',
    titleAr: 'مول مصر',
    titleEn: 'Mall of Egypt',
    locationAr: 'القاهرة، 6 أكتوبر',
    locationEn: 'Cairo, 6th of October City',
    category: 'commercial',
    status: 'ongoing',
    progress: 72,
    image: '/images/waha_mall.png',
    images: [
      '/images/waha_mall.png',
    ],
    descriptionAr: 'مول تجاري حديث يوفر تجربة تسوق متكاملة، يضم أشهر العلامات التجارية العالمية ومساحات ترفيهية ومطاعم تلبي كافة الأذواق.',
    descriptionEn: 'A modern commercial mall providing an integrated shopping experience, featuring top international brands, entertainment spaces, and restaurants for all tastes.',
    features: ['محلات تجارية', 'منطقة مطاعم', 'أماكن ترفيهية', 'موقف متعدد الطوابق', 'نظام ذكي', 'إنترنت فائق السرعة'],
    area: '68,000',
    year: '2024',
    mapEmbedUrl: 'https://maps.google.com/maps?q=29.9702,31.0185&z=15&output=embed',
  },
  {
    id: 'al-madar-complex',
    titleAr: 'مجمع المدار متعدد الاستخدامات',
    titleEn: 'Al Madar Mixed-Use Complex',
    locationAr: 'أسوان، كورنيش النيل',
    locationEn: 'Aswan, Nile Corniche',
    category: 'mixed',
    status: 'upcoming',
    progress: 15,
    image: '/images/madar_complex.png',
    images: [
      '/images/madar_complex.png',
    ],
    descriptionAr: 'مشروع ضخم متعدد الاستخدامات يجمع بين السكن الفاخر والتجارة والترفيه على مساحة 120 ألف متر مربع في قلب أسوان الساحرة.',
    descriptionEn: 'A mega mixed-use project combining luxury living, retail, and entertainment across 120,000 square meters in the heart of charming Aswan.',
    features: ['وحدات سكنية', 'مركز تجاري', 'فندق 5 نجوم', 'مركز ترفيهي', 'حدائق عامة', 'إطلالة على النيل'],
    area: '120,000',
    year: '2025',
    units: 350,
    mapEmbedUrl: 'https://maps.google.com/maps?q=24.0889,32.8998&z=15&output=embed',
  },
  {
    id: 'green-villas',
    titleAr: 'مشروع الفلل الخضراء',
    titleEn: 'Green Villas Project',
    locationAr: 'الإسكندرية، برج العرب',
    locationEn: 'Alexandria, Borg El Arab',
    category: 'residential',
    status: 'completed',
    progress: 100,
    image: '/images/green_villas.png',
    images: [
      '/images/green_villas.png',
    ],
    descriptionAr: 'مشروع فلل فاخرة بتصميم عصري يجمع بين الطراز الراقي والمعمار الحديث مع مساحات خضراء واسعة لبيئة سكنية هادئة.',
    descriptionEn: 'A luxury villa project with modern design combining elegant style with contemporary architecture and expansive green spaces for a serene living environment.',
    features: ['حديقة خاصة', 'مسبح خاص', 'مساحات خضراء', 'مجلس واسع', 'مطبخ مجهز', 'تصميم عصري'],
    area: '32,000',
    year: '2022',
    units: 45,
    mapEmbedUrl: 'https://maps.google.com/maps?q=30.9167,29.5833&z=15&output=embed',
  },
  {
    id: 'business-hub',
    titleAr: 'مركز الأعمال الإداري',
    titleEn: 'Administrative Business Hub',
    locationAr: 'القاهرة، العاصمة الإدارية',
    locationEn: 'Cairo, New Administrative Capital',
    category: 'commercial',
    status: 'ongoing',
    progress: 45,
    image: '/images/business_hub.png',
    images: [
      '/images/business_hub.png',
    ],
    descriptionAr: 'مركز أعمال إداري متكامل مجهز بأحدث التقنيات لاستضافة الشركات في بيئة إبداعية محفزة بالعاصمة الإدارية الجديدة.',
    descriptionEn: 'An integrated administrative business center equipped with the latest technologies to host companies in a stimulating creative environment in the New Administrative Capital.',
    features: ['مكاتب مرنة', 'مساحات تشاركية', 'قاعات مؤتمرات', 'كافيه', 'ألواح طاقة شمسية', 'مواقف ذكية'],
    area: '28,000',
    year: '2024',
    mapEmbedUrl: 'https://maps.google.com/maps?q=30.0033,31.7853&z=15&output=embed',
  },
  {
    id: 'luxury-towers',
    titleAr: 'أبراج العلمين الساحلية',
    titleEn: 'Alamein Coastal Towers',
    locationAr: 'العلمين الجديدة',
    locationEn: 'New Alamein City',
    category: 'mixed',
    status: 'upcoming',
    progress: 5,
    image: '/images/luxury_towers.png',
    images: [
      '/images/luxury_towers.png',
    ],
    descriptionAr: 'مشروع فاخر يتكون من برجين شاهقين، يضمان شققاً فندقية ووحدات سكنية فاخرة مع إطلالات خلابة على البحر الأبيض المتوسط.',
    descriptionEn: 'A luxury project consisting of two soaring towers featuring hotel apartments and luxury residential units with breathtaking views of the Mediterranean Sea.',
    features: ['إطلالة بحرية', 'شقق فندقية', 'مول تجاري', 'سبا فاخر', 'نادي شاطئي', 'حمامات سباحة'],
    area: '95,000',
    year: '2026',
    units: 280,
    mapEmbedUrl: 'https://maps.google.com/maps?q=30.8250,28.9483&z=15&output=embed',
  },
];
